...
namespace shintack\LaravelLogger;

use Illuminate\Routing\Router;
use Illuminate\Support\ServiceProvider;
use shintack\LaravelLogger\App\Http\Middleware\LogActivity;
...
class LaravelLoggerServiceProvider extends ServiceProvider
{
    ...
    protected $listeners = [
        ...
        'Illuminate\Auth\Events\Attempting' => [
            'shintack\LaravelLogger\App\Listeners\LogAuthenticationAttempt',
        ],

        'Illuminate\Auth\Events\Authenticated' => [
            'shintack\LaravelLogger\App\Listeners\LogAuthenticated',
        ],

        'Illuminate\Auth\Events\Login' => [
            'shintack\LaravelLogger\App\Listeners\LogSuccessfulLogin',
        ],

        'Illuminate\Auth\Events\Failed' => [
            'shintack\LaravelLogger\App\Listeners\LogFailedLogin',
        ],

        'Illuminate\Auth\Events\Logout' => [
            'shintack\LaravelLogger\App\Listeners\LogSuccessfulLogout',
        ],

        'Illuminate\Auth\Events\Lockout' => [
            'shintack\LaravelLogger\App\Listeners\LogLockout',
        ],

        'Illuminate\Auth\Events\PasswordReset' => [
            'shintack\LaravelLogger\App\Listeners\LogPasswordReset',
        ],
